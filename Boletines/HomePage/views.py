...
def boletin_junio_2024_descargar(request):
    file_path =  r'C:\Users\holis\OneDrive\Escritorio\Analisis y diseño\GRUPO07-2024-PROYINF-main\Boletines\HomePage\templates\PDFs\articles-126033_archivo_01.pdf'
    response = FileResponse(open(file_path, 'rb'), content_type='application/pdf')
...
def descargar_pdf(request):
    ...
    pdf_path = os.path.join('C:/Users/holis/OneDrive/Escritorio/Analisis y diseño/GRUPO07-2024-PROYINF-main/Boletines/HomePage/templates/PDFs/', 'articles-126721_archivo_01.pdf')
    
    # Sirve el archivo PDF como una respuesta
    return FileResponse(open(pdf_path, 'rb'), content_type='application/pdf')

def enviar_parametros(request):
    file_path = r'C:\Users\holis\OneDrive\Escritorio\Analisis y diseño\GRUPO07-2024-PROYINF-main\Boletines\HomePage\templates\PDFs\articles-126721_archivo_01.pdf'
    response = FileResponse(open(file_path, 'rb'), content_type='application/pdf')
    response['Content-Disposition'] = 'inline; filename="mi_boletin.pdf"'
    return response
def descargar_boletin(request):
